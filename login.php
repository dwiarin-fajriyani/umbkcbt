			...
			<div class="animated flipInX wrap-login100" style="padding-top:30px">
				<form id="formlogin" action="ceklogin.php" class="login100-form validate-form">
					...
					<div class="container-login100-form-btn">
						...
						<p><a target="blank" href="https://api.whatsapp.com/send?phone=628123456789&text=Halo%20Admin%20Saya%20Lupa%20Password"> Lupa Password Chat Admin!</a></p>
	...
	<script>
		$(document).ready(function() {
			$('#formlogin').submit(function(e) {
				var homeurl;
				homeurl = '<?php echo $homeurl; ?>/jadwal';
				e.preventDefault();
				$.ajax({
					type: 'POST',
