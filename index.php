...
<body class='hold-transition skin-green-light  fixed <?= $sidebar ?>'>
    ...
    <div class='wrapper'>
        <header class='main-header'>
            <a href='javascript:window.location.reload(true)' class='logo' style='background-color:#283c86'>
        ...
        <aside class='main-sidebar'>
            <section class='sidebar'>
                ...
                <ul class='sidebar-menu tree' data-widget='tree'>
                    ...
                    <li><a href='<?= $homeurl ?>/jadwal'><i class='fas fa-edit fa-fw  '></i> <span> Jadwal Ujian</span></a></li>  
                    <li><a href='<?= $homeurl ?>/hasil'><i class='fas fa-tags fa-fw '></i> <span> Hasil Ujian</span></a></li>
					<li><a href='<?= $homeurl ?>'><i class='fas fa-bullhorn fa-fw  '></i> <span> Informasi</span></a></li> 
                </ul><!-- /.sidebar-menu -->
            </section>
        </aside>
        <div class='content-wrapper' style='background-image: url(admin/backgroun.jpg);background-size: cover;'>
            <section class='content-header' style="height:102px;z-index:0;background:linear-gradient(to right, #283c86, #45a247)">
            </section>
        ...
        <footer class='main-footer hidden-xs'>
            <div class='container'>
                <div class='pull-left hidden-xs'>
                    <strong>
                        <span id='end-sidebar'>
                            &copy; 2022 <?= APLIKASI . " v" . VERSI . " r" . REVISI ?> <a href="https://aplikasipendidikan.net">Aplikasi Pendidikan</a>
                        </span>
                    </strong>
                </div>
        </footer>
