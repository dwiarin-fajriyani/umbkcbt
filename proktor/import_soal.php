    ...
    <div class='col-md-12'>
        ...
        <div class='box box-solid'>
            <div class='box-header with-border'>
                <h3 class='box-title'>Import Soal UMBK</h3>
            ...
            <div class='box-body'>
                ...
                <div class='col-md-6'>
                    <form id="formsoalword" action='<?= $homeurl ?>/proktor/pages/word_import/import/index.php/word_import' method='post' enctype='multipart/form-data'>
                        <div class='box box-solid'>
                            <div class='box-header with-border'>
                            ...
                            <div class='box-footer'>
                                <a href='<?= $homeurl ?>/proktor/pages/word_import/import/sample/sample.docx'><i class='fa fa-file-word-o'></i> Download Format</a>
                            </div>
                        </div><!-- /.box -->
                    </form>
                </div>
